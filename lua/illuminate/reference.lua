...
local function ref_before(ref1, ref2)
  return pos_before(ref1[1], ref2[1])
    or pos_equal(ref1[1], ref2[1]) and pos_before(ref1[2], ref2[2])
end
...
function M.is_pos_in_ref(pos, ref)
  return (pos_before(ref[1], pos) or pos_equal(ref[1], pos))
    and (pos_before(pos, ref[2]) or pos_equal(pos, ref[2]))
end
